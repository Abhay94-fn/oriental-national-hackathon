...
const backgroundGradientClasses =
  "absolute inset-0 bg-gradient-to-br from-neutral-800/40 via-neutral-900/30 to-neutral-950"
...
export function TerminalAnimationBlinkingCursor({
  ...
  return (
    <span
      aria-hidden
      className={cn(
        "ml-0.5 inline-block h-[18px] w-[7px] translate-y-[3px] animate-pulse bg-muted-foreground duration-1000",
        className
      )}
